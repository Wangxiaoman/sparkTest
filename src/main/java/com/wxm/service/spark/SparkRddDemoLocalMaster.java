...
public class SparkRddDemoLocalMaster {
	public static void main(String[] args) {
		String fileName = "/Users/xiaomanwang/tool/hadoop/words.txt";
		SparkConf conf = new SparkConf().setAppName("Word Count").setMaster("spark://172.27.150.160:7077")
				.set("spark.executor.memory", "1g")
				.setJars(new String[]{"/Users/xiaomanwang/workspace/recom-test/target/recom-test-1.0-SNAPSHOT.jar"});
...
//				.set("spark.executor.memory", "1g");
		...
		JavaPairRDD<String, Integer> map = filterWords.mapToPair(word -> new Tuple2<>(word, 1))
				.reduceByKey((a, b) -> a + b);
